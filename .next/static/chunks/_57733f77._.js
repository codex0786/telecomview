(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_57733f77._.js", {

"[project]/lib/cableData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/networkData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/dataHooks.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/cableData.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$networkData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/networkData.ts [app-client] (ecmascript)");
...
function useSubmarineCableData() {
    _s();
    const { setCables, setTotalCables } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSubmarineCableData.useEffect": ()=>{
            setCables(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUBMARINE_CABLES"]);
            setTotalCables(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUBMARINE_CABLES"].length);
        }
    }["useSubmarineCableData.useEffect"], []); // eslint-disable-line
}
_s(useSubmarineCableData, "RqeH9roXxZK+TLWTePuoElurH9E=", false, function() {
    return [
...
function useCloudRegionData() {
    _s1();
    const { setCloudRegions, setTotalRegions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCloudRegionData.useEffect": ()=>{
            setCloudRegions(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLOUD_REGIONS"]);
            setTotalRegions(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLOUD_REGIONS"].length);
        }
    }["useCloudRegionData.useEffect"], []); // eslint-disable-line
}
_s1(useCloudRegionData, "9G3PfAHMhVqCZTn+zixrwPyZtPI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
function useIXPData() {
    _s2();
    const { setIxps, setTotalIXPs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useIXPData.useEffect": ()=>{
            setIxps(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$networkData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IXP_DATA"]);
            setTotalIXPs(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$networkData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IXP_DATA"].length);
        }
    }["useIXPData.useEffect"], []); // eslint-disable-line
}
_s2(useIXPData, "oIx4ULdAua4Snj8/PAdm/7rWoG8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
function useFiberData() {
    _s3();
    const { setFiberRoutes } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFiberData.useEffect": ()=>{
            setFiberRoutes(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FIBER_ROUTES"]);
        }
    }["useFiberData.useEffect"], []); // eslint-disable-line
}
_s3(useFiberData, "/Ce9XTN1lXZaPRD2ojeAbyr8TQM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
...
function useBGPAlertData() {
    _s4();
    const { setBgpAlerts, setTotalAlerts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    ...
    const generate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBGPAlertData.useCallback[generate]": ()=>{
            const count = 3 + Math.floor(Math.random() * 5);
            const shuffled = [
                ...BGP_POOL
            ].sort({
                "useBGPAlertData.useCallback[generate].shuffled": ()=>Math.random() - 0.5
            }["useBGPAlertData.useCallback[generate].shuffled"]).slice(0, count);
            const alerts = shuffled.map({
                "useBGPAlertData.useCallback[generate].alerts": (t, i)=>({
                        ...t,
                        id: `bgp-${Date.now()}-${i}`,
                        timestamp: Date.now() - Math.floor(Math.random() * 3_600_000)
                    })
            }["useBGPAlertData.useCallback[generate].alerts"]);
            setBgpAlerts(alerts);
...
_s4(useBGPAlertData, "SA+BXnavx6llHhtuQlfAl5moRzY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
...
function useOutageData() {
    _s5();
    const { setOutages, setTotalOutages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    const intervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const generate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useOutageData.useCallback[generate]": ()=>{
            const count = 2 + Math.floor(Math.random() * 3);
            const shuffled = [
                ...OUTAGE_POOL
            ].sort({
                "useOutageData.useCallback[generate].shuffled": ()=>Math.random() - 0.5
            }["useOutageData.useCallback[generate].shuffled"]).slice(0, count);
            const outages = shuffled.map({
                "useOutageData.useCallback[generate].outages": (t, i)=>({
                        ...t,
                        id: `outage-${Date.now()}-${i}`,
                        startTime: Date.now() - Math.floor(Math.random() * 7_200_000)
                    })
            }["useOutageData.useCallback[generate].outages"]);
            setOutages(outages);
...
_s5(useOutageData, "v6Ftyvcn/BuWdhafmZMAZ+Qfzm4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
...
function useCellTowerData() {
    _s6();
    const { setCellTowers, setTotalTowers, cameraPosition, layers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCellTowerData.useEffect": ()=>{
            ...
            const towers = Array.from({
                ...
                "useCellTowerData.useEffect.towers": (_, i)=>{
            ...
            }["useCellTowerData.useEffect.towers"]);
...
_s6(useCellTowerData, "znehLQ8y8amP8M4WprDX/NBaYwA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
...
function useLatencyData() {
    _s7();
    const { setLatencyProbes, layers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    const intervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useLatencyData.useEffect": ()=>{
            if (!layers.latencyHeatmap) {
                setLatencyProbes([]);
                return;
            }
            const generate = {
                "useLatencyData.useEffect.generate": ()=>{
                    const probes = PROBE_LOCATIONS.map({
                        "useLatencyData.useEffect.generate.probes": (loc, i)=>{
                    ...
                    }["useLatencyData.useEffect.generate.probes"]);
...
_s7(useLatencyData, "x1PbLp3NS0SNDt7w4eYxXdAh5n0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"]
    ];
});
...
"[project]/components/GlobeViewer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/TelecomViewContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dataHooks.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/cloudData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/cableData.ts [app-client] (ecmascript)");
;
...
// ── Main Component ────────────────────────────────────────────────────────────
const GlobeViewer = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s((_props, ref)=>{
    _s();
    ...
    const isInit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const clockRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const dayNightRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const imgRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        sat: null,
        night: null,
        contLabels: null,
        cityLabels: null
    });
    const { cables, layers, selectedCable, setSelectedCable, cloudRegions, selectedRegion, setSelectedRegion, ixps, selectedIXP, setSelectedIXP, bgpAlerts, setSelectedAlert, outages, setSelectedOutage, cellTowers, setSelectedTower, fiberRoutes, latencyProbes, setCameraPosition, setIsLoading, setHoverTooltip } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"])();
    // Mount all data hooks
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSubmarineCableData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCloudRegionData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIXPData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFiberData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBGPAlertData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutageData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCellTowerData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLatencyData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useImperativeHandle"])(ref, {
        "GlobeViewer.useImperativeHandle": ()=>({
                flyTo: ({
                    "GlobeViewer.useImperativeHandle": (lat, lng, alt = 2_000_000)=>{
                ...
                screenshot: ({
                    "GlobeViewer.useImperativeHandle": async ()=>{
                        const v = viewerRef.current;
                        if (!v) return null;
                        return new Promise({
                            "GlobeViewer.useImperativeHandle": (resolve)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            if (isInit.current || !containerRef.current) return;
            const boot = {
                "GlobeViewer.useEffect.boot": async ()=>{
                    if (!window.Cesium) {
                        setTimeout(boot, 200);
                        return;
                    }
                    ...
                    try {
                        ...
                        if (C.createWorldTerrainAsync) {
                            C.createWorldTerrainAsync({
                                ...
                                "GlobeViewer.useEffect.boot": (tp)=>{
                                    if (!viewer.isDestroyed()) viewer.terrainProvider = tp;
                                }
                            }["GlobeViewer.useEffect.boot"]).catch({
                                "GlobeViewer.useEffect.boot": ()=>{}
                            }["GlobeViewer.useEffect.boot"]);
                        }
                        // ── Step 5: Night lights overlay (Ion asset 3) ────────────────────
                        C.IonImageryProvider.fromAssetId(3).then({
                            "GlobeViewer.useEffect.boot": (np)=>{
                        ...
                        }["GlobeViewer.useEffect.boot"], 1000);
                        ...
                        handler.setInputAction({
                            "GlobeViewer.useEffect.boot": (click)=>{
                                ...
                                [
                                    ...
                                    "GlobeViewer.useEffect.boot": (fn)=>fn(null)
                                }["GlobeViewer.useEffect.boot"]);
                                ...
                                if (type === "cable") {
                                    ...
                                    const cable = cables.find({
                                        "GlobeViewer.useEffect.boot.cable": (c)=>c.id === id
                                    }["GlobeViewer.useEffect.boot.cable"]);
                                    if (cable) setSelectedCable(cable);
                                } else if (type === "cloud") {
                                    const id = p.regionId?.getValue();
                                    const region = cloudRegions.find({
                                        "GlobeViewer.useEffect.boot.region": (r)=>r.id === id
                                    }["GlobeViewer.useEffect.boot.region"]);
                                    if (region) setSelectedRegion(region);
                                } else if (type === "ixp") {
                                    const id = p.ixpId?.getValue();
                                    const ixp = ixps.find({
                                        "GlobeViewer.useEffect.boot.ixp": (i)=>i.id === id
                                    }["GlobeViewer.useEffect.boot.ixp"]);
                                    if (ixp) setSelectedIXP(ixp);
                                } else if (type === "bgp") {
                                    const id = p.alertId?.getValue();
                                    const alert = bgpAlerts.find({
                                        "GlobeViewer.useEffect.boot.alert": (a)=>a.id === id
                                    }["GlobeViewer.useEffect.boot.alert"]);
                                    if (alert) setSelectedAlert(alert);
                                } else if (type === "outage") {
                                    const id = p.outageId?.getValue();
                                    const outage = outages.find({
                                        "GlobeViewer.useEffect.boot.outage": (o)=>o.id === id
                                    }["GlobeViewer.useEffect.boot.outage"]);
                                    if (outage) setSelectedOutage(outage);
                                } else if (type === "tower") {
                                    const id = p.towerId?.getValue();
                                    const tower = cellTowers.find({
                                        "GlobeViewer.useEffect.boot.tower": (t)=>t.id === id
                                    }["GlobeViewer.useEffect.boot.tower"]);
                                    if (tower) setSelectedTower(tower);
                                }
                            }
                        }["GlobeViewer.useEffect.boot"], C.ScreenSpaceEventType.LEFT_CLICK);
                        // Hover handler
                        handler.setInputAction({
                            "GlobeViewer.useEffect.boot": (move)=>{
                        ...
                        }["GlobeViewer.useEffect.boot"], C.ScreenSpaceEventType.MOUSE_MOVE);
                        setTimeout({
                            "GlobeViewer.useEffect.boot": ()=>setIsLoading(false)
                        }["GlobeViewer.useEffect.boot"], 2400);
    ...
    }["GlobeViewer.useEffect"], []); // eslint-disable-line
    // ── 🌊 SUBMARINE CABLES ──────────────────────────────────────────────────
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            const v = viewerRef.current;
            if (!v || !window.Cesium) return;
            const C = window.Cesium;
            cableEntities.forEach({
                "GlobeViewer.useEffect": (segs)=>segs.forEach({
                        "GlobeViewer.useEffect": (e)=>v.entities.remove(e)
                    }["GlobeViewer.useEffect"])
            }["GlobeViewer.useEffect"]);
            cableEntities.clear();
            if (!layers.submarineCables) return;
            cables.forEach({
                "GlobeViewer.useEffect": (cable)=>{
                    const isSel = selectedCable?.id === cable.id;
                    const color = C.Color.fromCssColorString(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CABLE_STATUS_COLORS"][cable.status] || "#00f5ff");
                    const segs = [];
                    if (cable.coordinates.length >= 2) {
                        const positions = cable.coordinates.map({
                            "GlobeViewer.useEffect.positions": ([lng, lat])=>C.Cartesian3.fromDegrees(lng, lat, -2000)
                        }["GlobeViewer.useEffect.positions"]);
                    ...
                    cable.landingPoints.forEach({
                        "GlobeViewer.useEffect": (lp, i)=>{
                            segs.push(v.entities.add({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            cloudRegions.forEach({
                "GlobeViewer.useEffect": (region)=>{
                    const color = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROVIDER_COLORS"][region.provider] || "#ffffff";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            bgpAlerts.filter({
                "GlobeViewer.useEffect": (a)=>a.lat && a.lng
            }["GlobeViewer.useEffect"]).forEach({
                "GlobeViewer.useEffect": (alert)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            if (!v || !window.Cesium) return;
            const C = window.Cesium;
            outageEntities.forEach({
                "GlobeViewer.useEffect": (e)=>v.entities.remove(e)
            }["GlobeViewer.useEffect"]);
            outageEntities.clear();
            if (!layers.outages) return;
            outages.forEach({
                "GlobeViewer.useEffect": (outage)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            fiberRoutes.forEach({
                "GlobeViewer.useEffect": (route)=>{
                    if (route.coordinates.length < 2) return;
                    const positions = route.coordinates.map({
                        "GlobeViewer.useEffect.positions": ([lng, lat])=>C.Cartesian3.fromDegrees(lng, lat, 5000)
                    }["GlobeViewer.useEffect.positions"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            if (!v || !window.Cesium) return;
            const C = window.Cesium;
            towerEntities.forEach({
                "GlobeViewer.useEffect": (e)=>v.entities.remove(e)
            }["GlobeViewer.useEffect"]);
            towerEntities.clear();
            if (!layers.cellTowers || cellTowers.length === 0) return;
            cellTowers.forEach({
                "GlobeViewer.useEffect": (tower)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobeViewer.useEffect": ()=>{
            ...
            if (!v || !window.Cesium) return;
            const C = window.Cesium;
            latencyEntities.forEach({
                "GlobeViewer.useEffect": (e)=>v.entities.remove(e)
            }["GlobeViewer.useEffect"]);
            latencyEntities.length = 0;
            if (!layers.latencyHeatmap || latencyProbes.length === 0) return;
            latencyProbes.forEach({
                "GlobeViewer.useEffect": (probe)=>{
...
}, "RgpFb6cIs/uLoGvx3oxpXhOHsWw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSubmarineCableData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCloudRegionData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIXPData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFiberData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBGPAlertData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutageData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCellTowerData"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLatencyData"]
    ];
})), "RgpFb6cIs/uLoGvx3oxpXhOHsWw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$TelecomViewContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTelecomView"],
...
var _c, _c1;
__turbopack_context__.k.register(_c, "GlobeViewer$forwardRef");
__turbopack_context__.k.register(_c1, "GlobeViewer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/components/GlobeViewer.tsx [app-client] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/components/GlobeViewer.tsx [app-client] (ecmascript)"));
}}),
}]);

//# sourceMappingURL=_57733f77._.js.map